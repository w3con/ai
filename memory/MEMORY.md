...
- [How a letter is written](feedback-letter-style-rules.md) — Validité only: read `kb/BizDev/letter-style.md` first; no signpost sentences, one chain of consequences, no answering unraised objections, every sentence carries a fact, a request or a consequence
