...
- [No cold contacts from websites](feedback-no-cold-contacts-from-websites.md) — a name and number on an organisation's site is published information, not a contact; use the published process, and a declined channel stays declined
