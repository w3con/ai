...
**How to apply:** reproduce showcase values verbatim; when unsure, the move is mini-plan-on-disk + interview, not a best-guess build. Note he often fires several messages that queue and arrive *after* I've already asked — do not re-ask what a later message already answered.
