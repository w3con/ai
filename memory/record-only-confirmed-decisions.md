...
**How to apply:** propose in chat → wait for explicit confirmation → then record as decided. If something genuinely must be noted before confirmation, keep it in a clearly-labelled "open/proposed" section, never in an "answer"/"decided" slot. Distinguish firm decisions from soft preferences in the wording.
